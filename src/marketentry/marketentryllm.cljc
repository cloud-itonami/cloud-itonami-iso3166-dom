(ns marketentry.marketentryllm
  ...
  the Dominican Republic (DOM) public-sector market-entry compliance
  actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "mipyme-reserved-award?=" (:mipyme-reserved-award? e)
                        " women-led-claim?=" (:women-led-claim? e)
                        " micm-certification-valid?=" (:micm-certification-valid? e)
                        " micm-certification-women-led?=" (:micm-certification-women-led? e)
                        " fiscal-arrears-months=" (:fiscal-arrears-months e)
                        " months-since-grave-sanction=" (:months-since-grave-sanction e)
                        " rnc-record-verified?=" (:rnc-record-verified? e)
     ...
     :confidence (if (and e
                          (or (not (:requires-rnc-record? e))
                              (:rnc-record-verified? e)))
                   0.9 0.3)}))
