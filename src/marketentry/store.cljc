(ns marketentry.store
  "SSoT for the Dominican Republic (DOM) market-entry compliance
...
(defn demo-data
  ...
  `:mipyme-reserved-award?` / `:women-led-claim?` /
  `:micm-certification-valid?` / `:micm-certification-women-led?` /
  `:fiscal-arrears-months` / `:months-since-grave-sanction` are ground
  truth for the `mipyme-reserved-ineligible` flagship check (Ley 47-25
  Art. 172, Decreto 52-26 Arts. 222-223); `:requires-rnc-record?` /
  `:rnc-record-verified?` are ground truth for the conditional RNC
  tax-record check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Malecón Ingeniería SRL" :portal "dgcp.gob.do/comprasdominicana.gob.do"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :mipyme-reserved-award? false :women-led-claim? false
             :micm-certification-valid? false :micm-certification-women-led? false
             :fiscal-arrears-months 0 :months-since-grave-sanction nil
             :requires-rnc-record? true :rnc-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "DOM" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "dgcp.gob.do/comprasdominicana.gob.do"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :mipyme-reserved-award? false :women-led-claim? false
             :micm-certification-valid? false :micm-certification-women-led? false
    ...
    "eng-3" {:id "eng-3" :operator "Cibao Sistemas SAS" :portal "dgcp.gob.do/comprasdominicana.gob.do"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "DOM" :status :intake}
    "eng-4" {:id "eng-4" :operator "Quisqueya Textiles MIPYME SRL" :portal "dgcp.gob.do/comprasdominicana.gob.do"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :mipyme-reserved-award? true :women-led-claim? true
             :micm-certification-valid? true :micm-certification-women-led? false
             :fiscal-arrears-months 8 :months-since-grave-sanction 3
             :requires-rnc-record? true :rnc-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "DOM" :status :intake}
    "eng-5" {:id "eng-5" :operator "Puerto Plata Logística SRL" :portal "dgcp.gob.do/comprasdominicana.gob.do"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :mipyme-reserved-award? false :women-led-claim? false
             :micm-certification-valid? false :micm-certification-women-led? false
             :fiscal-arrears-months 0 :months-since-grave-sanction nil
             :requires-rnc-record? true :rnc-record-verified? false
             :drafted? false :submitted? false
             :jurisdiction "DOM" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               mipyme-reserved-award? women-led-claim?
                               micm-certification-valid? micm-certification-women-led?
                               fiscal-arrears-months months-since-grave-sanction
                               requires-rnc-record? rnc-record-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? mipyme-reserved-award?)        (assoc :engagement/mipyme-reserved-award? mipyme-reserved-award?)
    (some? women-led-claim?)              (assoc :engagement/women-led-claim? women-led-claim?)
    (some? micm-certification-valid?)     (assoc :engagement/micm-certification-valid? micm-certification-valid?)
    (some? micm-certification-women-led?) (assoc :engagement/micm-certification-women-led? micm-certification-women-led?)
    (some? fiscal-arrears-months)         (assoc :engagement/fiscal-arrears-months fiscal-arrears-months)
    (some? months-since-grave-sanction)   (assoc :engagement/months-since-grave-sanction months-since-grave-sanction)
    (some? requires-rnc-record?)          (assoc :engagement/requires-rnc-record? requires-rnc-record?)
    (some? rnc-record-verified?)          (assoc :engagement/rnc-record-verified? rnc-record-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/mipyme-reserved-award? :engagement/women-led-claim?
   :engagement/micm-certification-valid? :engagement/micm-certification-women-led?
   :engagement/fiscal-arrears-months :engagement/months-since-grave-sanction
   :engagement/requires-rnc-record? :engagement/rnc-record-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :mipyme-reserved-award? (boolean (:engagement/mipyme-reserved-award? m))
     :women-led-claim? (boolean (:engagement/women-led-claim? m))
     :micm-certification-valid? (boolean (:engagement/micm-certification-valid? m))
     :micm-certification-women-led? (boolean (:engagement/micm-certification-women-led? m))
     :fiscal-arrears-months (:engagement/fiscal-arrears-months m)
     :months-since-grave-sanction (:engagement/months-since-grave-sanction m)
     :requires-rnc-record? (boolean (:engagement/requires-rnc-record? m))
     :rnc-record-verified? (boolean (:engagement/rnc-record-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-dom"})
